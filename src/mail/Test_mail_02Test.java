...
public class Test_mail_02Test {

	// 对于开启了独立密码的邮箱, 这里的邮箱密码必需使用这个独立密码（授权码）。
//	public static String myEmailAccount = "bad@ddt.com";
	public static String myEmailAccount = "YahooNews@jpn.com";
	public static String myEmailPassword = "pwdpwdpwd";

	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	// 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
	public static String myEmailSMTPHost = "10.8.161.18";
//	public static String myEmailSMTPHost = "10.8.162.180"; // TZ 570P
//	public static String myEmailSMTPHost = "10.8.162.173"; // NSA 2700

	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "jason@ddt.com";
//	public static String receiveMailAccount = "Administrator@ddt.com";
